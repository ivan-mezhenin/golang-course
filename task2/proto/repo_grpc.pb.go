...
const (
	RepoService_GetRepoInfo_FullMethodName = "/repo.RepoService/GetRepoInfo"
)
...
func (c *repoServiceClient) GetRepoInfo(ctx context.Context, in *GetRepoRequest, opts ...grpc.CallOption) (*GetRepoResponse, error) {
...
func (UnimplementedRepoServiceServer) GetRepoInfo(context.Context, *GetRepoRequest) (*GetRepoResponse, error) {
...
func _RepoService_GetRepoInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RepoServiceServer).GetRepoInfo(ctx, req.(*GetRepoRequest))
	}
