...
const file_proto_collector_collector_proto_rawDesc = "" +
	"\n" +
	"\x1fproto/collector/collector.proto\x12\tcollector\"\xb2\x01\n" +
	...
	"\tCollector\x12F\n" +
	"\vGetRepoInfo\x12\x19.collector.GetRepoRequest\x1a\x1a.collector.GetRepoResponse\"\x00\x127\n" +
	"\x04Ping\x12\x16.collector.PingRequest\x1a\x17.collector.PingResponseB\x1bZ\x19repo-stat/proto/collectorb\x06proto3"
...
var file_proto_collector_collector_proto_depIdxs = []int32{
	1, // 0: collector.Collector.GetRepoInfo:input_type -> collector.GetRepoRequest
	2, // 1: collector.Collector.Ping:input_type -> collector.PingRequest
	0, // 2: collector.Collector.GetRepoInfo:output_type -> collector.GetRepoResponse
