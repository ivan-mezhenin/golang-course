...
func (c *subscriberClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingResponse, error) {
	...
	err := c.cc.Invoke(ctx, Subscriber_Ping_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *subscriberClient) PostSubscription(ctx context.Context, in *PostSubscriptionRequest, opts ...grpc.CallOption) (*PostSubscriptionResponse, error) {
	...
	err := c.cc.Invoke(ctx, Subscriber_PostSubscription_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSubscriberServer) PostSubscription(context.Context, *PostSubscriptionRequest) (*PostSubscriptionResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PostSubscription not implemented")
}
